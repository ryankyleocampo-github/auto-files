...
class FileCopierDialog(QWidget):
    ...
    def init_ui(self):
        ...
        instruction_label = QLabel("Step 7: Move files on SD card to date directory.")
        ...
        move_all_button = QPushButton('Move File')
...
class AutoFileApp(QWidget):
    def __init__(self):
        ...
        main_button_names = ['Preview and Rename Files', 'Copy Files']
        for i in range(2):

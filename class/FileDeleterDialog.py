...
class FileDeleterDialog(QDialog):
    def __init__(self, parent=None):
        ...
        # Radio buttons for GoPro and Insta360
        self.radio_gopro = QRadioButton('GoPro')
        self.radio_insta360 = QRadioButton('Insta360')
        layout.addWidget(self.radio_gopro)
        layout.addWidget(self.radio_insta360)
